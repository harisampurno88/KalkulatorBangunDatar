...
public class PersegiPanjang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtPanjang.setBackground(new java.awt.Color(0, 51, 102));
        txtPanjang.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        txtPanjang.setForeground(new java.awt.Color(255, 255, 255));
        txtPanjang.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 204, 51)));
        ...
        jLabel2.setText("Panjang Persegi Panjang(CM)");
        ...
        jLabel5.setText("Rumus Luas Persegi Panjang : Panjang x Lebar");

        txtLebar.setBackground(new java.awt.Color(0, 51, 102));
        txtLebar.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        txtLebar.setForeground(new java.awt.Color(255, 255, 255));
        txtLebar.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 204, 51)));
        ...
        jLabel6.setText("Lebar Persegi Panjang(CM)");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(35, 35, 35)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtLebar, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnHitungActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHitungActionPerformed
        // TODO add your handling code here:
        if (txtPanjang.getText().isEmpty() && txtLebar.getText().isEmpty()) {
            JOptionPane.showMessageDialog(txtLebar, "Masukkan Panjang Dan Lebar Terlebih Dahulu", "Invalid Input", JOptionPane.WARNING_MESSAGE);
        } else if (txtPanjang.getText().isEmpty()) {
            JOptionPane.showMessageDialog(txtPanjang, "Masukkan Panjang Terlebih Dahulu", "Invalid Input", JOptionPane.WARNING_MESSAGE);
        } else if (txtLebar.getText().isEmpty()) {
            JOptionPane.showMessageDialog(txtLebar, "Masukkan Lebar Terlebih Dahulu", "Invalid Input", JOptionPane.WARNING_MESSAGE);
        } else {
            float luas = Float.parseFloat(txtPanjang.getText())*Float.parseFloat(txtLebar.getText());
    ...
    private void txtPanjangKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPanjangKeyTyped
        ...
        char c = evt.getKeyChar();
                String text = txtPanjang.getText();
                // Jika input bukan angka, bukan titik, dan bukan backspace
                if (!Character.isDigit(c) && c != '.' && c != KeyEvent.VK_BACK_SPACE) {
                    evt.consume(); // Batalkan input
                    JOptionPane.showMessageDialog(txtPanjang, "Tidak Boleh Mengisi Huruf!", "Invalid Input", JOptionPane.WARNING_MESSAGE);
                }
                if (c == '.' && text.contains(".")) {
                    evt.consume();
                    JOptionPane.showMessageDialog(txtPanjang, "Hanya bisa menggunakan satu titik desimal!", "Invalid Input", JOptionPane.WARNING_MESSAGE);
                }
                if (c == '.' && text.isEmpty()) {
                    evt.consume();
                    JOptionPane.showMessageDialog(txtPanjang, "Titik desimal tidak boleh di awal!", "Invalid Input", JOptionPane.WARNING_MESSAGE);
                }
    ...
    private void txtLebarKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtLebarKeyTyped
        // TODO add your handling code here:
        char c = evt.getKeyChar();
                String text = txtLebar.getText();
                // Jika input bukan angka, bukan titik, dan bukan backspace
                if (!Character.isDigit(c) && c != '.' && c != KeyEvent.VK_BACK_SPACE) {
                    evt.consume(); // Batalkan input
                    JOptionPane.showMessageDialog(txtLebar, "Tidak Boleh Mengisi Huruf!", "Invalid Input", JOptionPane.WARNING_MESSAGE);
                }
                if (c == '.' && text.contains(".")) {
                    evt.consume();
                    JOptionPane.showMessageDialog(txtLebar, "Hanya bisa menggunakan satu titik desimal!", "Invalid Input", JOptionPane.WARNING_MESSAGE);
                }
                if (c == '.' && text.isEmpty()) {
                    evt.consume();
                    JOptionPane.showMessageDialog(txtLebar, "Titik desimal tidak boleh di awal!", "Invalid Input", JOptionPane.WARNING_MESSAGE);
                }
